...
export default function Adopcion() {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <p className="text-lg mb-8 bg-gray-200 p-4 rounded-md text-gray-900">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {mascotas.map((mascota, index) => (
          <div key={index} className="bg-white shadow-md rounded-md overflow-hidden">
            ...
            <button className="bg-blue-500 text-white py-2 px-4 w-full rounded-md hover:bg-blue-600 transition duration-300">
              Contactar
            </button>
          </div>
        ))}
