...
export default function Page() {
  return (
    <div className="flex flex-col lg:flex-row mx-auto px-4 py-8 bg-violet-100">
      <div className=" w-1/3 flex flex-col  justify-around ml-auto mr-auto">
        ...
        <div className="lg:w-full bg-white p-6 rounded-lg">
      ...
      <div className="lg:w-1/2 mt-8 bg-white p-6 rounded-lg">
