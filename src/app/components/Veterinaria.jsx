      ...
      <div className='flex flex-wrap justify-center gap-8'>
        <div className='flex flex-col items-center w-full sm:w-1/2 md:w-1/3 p-5 sm:p-10 border border-cyan-100 rounded-lg bg-cyan-100'>
          ...
          <div className='flex flex-col items-center'>
            ...
            <Link href='/HomeCliente/Acciones/TurneroCheckeo' className='botonVeterinaria bg-blue-500 text-white w-full mt-5 p-2 border-2 border-cyan-100 rounded-lg'>Reservar</Link>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center p-5 sm:p-10 border w-full sm:w-1/2 md:w-1/3 border-cyan-100 rounded-lg bg-violet-400'>
          ...
          <div className='w-32 sm:w-40 md:w-auto mb-4 rounded-full overflow-hidden'>
            <Image src="/hd6.jpg" alt="veterinaria" width={100} height={100} className='imagenVeterinaria scale-100' />
          </div>
          <div className='flex flex-col items-center'>
            ...
            <Link href='/HomeCliente/Acciones/turneroPeluqueria' className='botonVeterinaria bg-blue-500 text-white w-full p-2 border-2 border-cyan-100 rounded-lg'>Reservar</Link>
          </div>
        </div>
{/* 
