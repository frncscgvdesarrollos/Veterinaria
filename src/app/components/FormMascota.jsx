...
import { useRouter } from 'next/navigation'; // Importar useRouter de next/router
...
export default function FormMascota() {
  ...
  useEffect(() => {
    if (mascotasCargadas) {
      router.push('/HomeCliente'); // Redireccionar a '/HomeCliente'
    }
  }, [mascotasCargadas, router]);

  return (
<form onSubmit={handleSubmit} className="w-full mx-auto bg-gray-300 p-6 rounded-lg">
  <section className="mt-8 mx-auto w-full">
    <p className="mb-4 text-gray-700 text-xl w-2/3 lg:w-full sm:text-center sm:mx-auto" >
  ...
  <div className="grid grid-cols-1 gap-4 md:grid-cols-1 sm:grid-cols-1 lg:grid-cols-2">
  ...
  <button type="submit" className="btn bg-red-500 p-2 bg-sky-500 sm:w-1/3 text-xl rounded mt-10">Siguiente paso</button>
</form>
