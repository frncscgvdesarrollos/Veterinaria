...
export default function MisTurnos() {
  ...
  const [expanded, setExpanded] = useState(false); // Nuevo estado para controlar la expansión de los turnos
  ...
  // Función para cambiar el estado de expansión de los turnos
  const toggleExpand = () => {
            ...
            <React.Fragment>
              ...
              <div className="bg-violet-300 bg-opacity-70 rounded-lg p-2 h-auto">
                <div key={0} className="mb-4">
                  <h2 className="text-xl font-semibold mb-2">{turnosCliente[0].fecha}</h2>
                  <ul>
                    <li className="mb-2">
              ...
              {/* Botón para mostrar/ocultar los turnos restantes */}
              <button
