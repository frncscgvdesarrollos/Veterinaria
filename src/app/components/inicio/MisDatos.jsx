...
import { FaUser, FaPhone, FaStar, FaCut, FaClipboardCheck } from 'react-icons/fa';
import { AiOutlineHome } from 'react-icons/ai';

export default function MisDatos() {
  const { datosCliente } = UseClient();
  const [datos, setDatos] = useState(false);
  const { nombre, apellido, direccion, telefono, esquina, esPremium, cortesTotales, chequeosTotales } = datosCliente;
  ...
  return (
    <div className="bg-violet-200 p-4 items-center h-auto rounded-lg mx-auto w-[330px] md:w-[500px]">
