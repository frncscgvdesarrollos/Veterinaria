    ...
    <div className='md:mx-auto'>
      <div className='w-full sm:w-full flex flex-col sm:flex-row items-center gap-20 container mx-auto md:mt-10 lg:mt-10'>
        <div className='flex flex-col sm:flex-row justify-between gap-8 w-full mx-auto container-perspective'>
          <div className='w-[300px] mr-10 md:mt-20 mx-auto sm:w-full md:w-[350px] py-5 sm:p-10 border-4 border-violet-200 rounded-lg bg-pink-200 h-full bg-opacity-80 md:ml-10 lg:ml-10 element2'>
          ...
          <div className='w-[300px] mr-10 md:mt-20 lg:h-full sm:w-full md:w-[350px] py-5 sm:p-10 border border-4 border-blue-200 rounded-lg bg-cyan-200 bg-opacity-80  md:mt-52 md:mr-10 element'>
            <div className='w-full flex sm:w-32 md:w-auto mb-2 rounded-full overflow-hidden mx-auto'>
