    ...
    <div className='mx-auto'>
      <div className='w-full sm:w-full flex flex-col sm:flex-row items-center gap-20 container mx-auto md:mt-10 lg:mt-10'>
        <div className='flex flex-col sm:flex-row justify-between gap-8 w-full mx-auto container-perspective'>
          ...
          <div className='hidden sm:hidden md:block w-full py-2 sm:w-1/2 md:w-1/3 border-4 border-blue-200 rounded-lg bg-purple-200 bg-opacity-80 md:mt-40 h-[650px]'>
            <Image src="/vete3.jpg" alt="veterinaria" width={350} height={350} className='imagenVeterinaria rounded-lg m-auto p-4' />
            <Image src="/vete4.jpg" alt="veterinaria" width={350} height={350} className='imagenVeterinaria rounded-lg m-auto p-4' />
          </div>
          <div className='w-[360px] mx-auto lg:h-full sm:w-full md:w-1/3 p-5 sm:p-10 border border-4 border-blue-200 rounded-lg bg-cyan-200 bg-opacity-80  md:mt-52 md:mr-10 element'>
            <div className='w-full flex sm:w-32 md:w-auto mb-2 rounded-full overflow-hidden mx-auto'>
