    ...
    <div>
      <div className='w-full sm:w-full flex flex-col sm:flex-row items-center gap-20 container mx-auto md:mt-10 lg:mt-10'>
        <div className='flex flex-col sm:flex-row justify-between gap-8 w-full mx-auto container-perspective'>
          <div className='w-full sm:w-full md:w-1/3 p-5 sm:p-10 border-4 border-violet-200 rounded-lg bg-pink-200 h-full bg-opacity-80 md:ml-10 lg:ml-10 element2 mx-auto text-center'>
            ...
            <h3 className='textoVeterinaria text-xl sm:text-3xl font-bold mt-5 mb-4 text-purple-800'>Chequeos</h3>
            <div className='flex flex-col items-center'>
              <p className='text-base sm:text-lg text-purple-800 font-semibold p-2 mb-2'>
          ...
          <div className='hidden sm:hidden md:block w-full py-2 sm:w-1/2 md:w-1/3 border-4 border-blue-200 rounded-lg bg-purple-200 bg-opacity-80 mt-10 h-full mx-auto text-center'>
          ...
          <div className='w-full lg:h-full sm:w-full md:w-1/3 p-5 sm:p-10 border w-full border-4 border-blue-200 rounded-lg bg-cyan-200 bg-opacity-80 mt-20 mr-10 element mx-auto text-center'>
            <div className='w-full flex sm:w-32 md:w-auto mb-2 rounded-full overflow-hidden mx-auto'>
              <Image src="/salchi2.jpg" alt="veterinaria" width={200} height={200} className=' scale-100 rounded-lg mx-auto mt-2' />
            </div>
            <h3 className='textoVeterinaria text-xl sm:text-3xl font-bold text-purple-800 mt-5 mb-4'>Peluquería</h3>
            <div className='flex flex-col items-center'>
              <p className='text-base sm:text-lg text-purple-700 font-semibold mb-2 p-2'>
