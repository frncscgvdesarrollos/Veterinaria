  ...
  return (
    <div className="bg-violet-200 bg-opacity-50 rounded-lg p-5 w-full mx-auto">
      ...
      <div className="p-5 rounded-lg bg-purple-600 bg-opacity-50 mx-auto text-center">
        <h1 className="text-3xl text-white">¡ Adopta a tu mascota !</h1>
      </div>
...
<div className="p-5 bg-purple-500 mt-5 bg-opacity-50 rounded-lg mx-auto w-full flex flex-col sm:flex-row">
  ...
  <Image src={'/adoptame2.jpg'} alt='Adopción' width={200} height={200} className='w-1/3 rounded-[20%]' />
</div>
      ...
      <p className="text-center text-red-500 bg-yellow-300 bg-opacity-50">Esta es nuestro granito de arena para facilitar las adopciones de mascotas.
               La veterinaria no se responsabiliza por usuarios maliciosos.
        </p>
    </div>
  );
}
