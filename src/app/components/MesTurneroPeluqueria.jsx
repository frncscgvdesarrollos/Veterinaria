  ...
  <div className="max-w-xl mx-auto bg-gray-100 rounded-md p-6">
    <form className="space-y-4" onSubmit={handleFormSubmit}>
      ...
      <div>
        ...
        >
          <option value="corte normal">Baño/corte higienico</option>
          <option value="corte higienico">Baño/corte higienico/pelar</option>
          <option value="corte especial">Baño/corte higienico/cepillado</option>
          <option value="corte de pelo">Baño/corte higienico/corte a tijera</option>
        </select>
      </div>
      <div>
